...
public class player_name extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NhapTen = (EditText)findViewById(R.id.edtusername);
        ...
        BatDau.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(player_name.this, quiz_test.class);
        ...
        TroVe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent1 = new Intent(player_name.this, minigame_quiz.class);
